    ...
    <main className="flex-grow w-full bg-black text-white py-[8rem] px-10 flex flex-col justify-start items-center gap-12">
      ...
      <div className="flex flex-wrap justify-center items-center gap-10">
        {contributors.map((contributor) => (
          <div
            key={contributor.id}
            className="w-72 p-4 border rounded-xl shadow text-center transition-transform duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg flex flex-col justify-center items-center gap-2 cursor-pointer"
          >
            <Image
