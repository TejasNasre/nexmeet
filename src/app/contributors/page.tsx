...
const ContributorsPage = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <main className="flex-grow w-full bg-black text-white py-[8rem] px-[2rem] flex flex-col justify-start items-center gap-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {contributors.map((contributor) => (
            <div key={contributor.id} className="p-4 border rounded shadow text-center">
              ...
              <a href={contributor.html_url} target="_blank" rel="noopener noreferrer" className="text-blue-500">
                View Profile
              </a>
            </div>
          ))}
